...
class Scheduler:
    ...
    def process_batch_result_prefill(self, batch: ScheduleBatch, result):
        if self.is_generation:
            model_forward_batch, (logits_output, next_token_ids) = result
            ...
            # logger.info("Resolve future begin")
            next_token_ids = self.tp_worker.resolve_future_token_ids(
                model_forward_batch.bid, next_token_ids
            )
            # logger.info("Resolve future end")
